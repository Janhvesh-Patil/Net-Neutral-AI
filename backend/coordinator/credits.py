...
# Validate directory is writable (critical for production deployments)
if not os.access(COORDINATOR_DIR, os.W_OK):
    raise RuntimeError(
        f"Coordinator directory {COORDINATOR_DIR} is not writable. "
        "Cannot create or access database.db. "

...
Usage:
    python pretrain.py data
    python pretrain.py data --epochs 5 --lr 0.001
"""
...
from coordinator.evaluate import evaluate, format_eval_result, format_accuracy_history, EvalResult
...
# Usage: python pretrain.py data --verify-only
# ─────────────────────────────────────────────────────────────────────────────
